...
public class State : MonoBehaviour {
    ...
    /* --- Variables --- */
    // Stats
    [SerializeField] [Range(0, 10)] public int maxHealth;
    [SerializeField] [ReadOnly] public int health; // The health 
    [SerializeField] [Range(0.05f, 20f)] public float baseSpeed; // How fast the entity moves.
